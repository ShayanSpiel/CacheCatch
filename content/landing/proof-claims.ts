 ...
 * and an optional source URL. Icon files are assigned in this data to preserve
 * the exact asset order used on the landing page.
 */
...
export const proofClaims: ProofClaim[] = [
  {
    ...
    iconSrc: "/landing/icons/trending-up.svg",
  },
  {
    value: "up to 80%",
    ...
    sourceLabel: "OpenAI prompt caching docs",
    sourceUrl: "https://platform.openai.com/docs/guides/prompt-caching",
    iconSrc: "/landing/icons/human-run.svg",
  },
  {
    value: "10%",
    ...
    iconSrc: "/landing/icons/percent.svg",
  },
  {
    value: "45-80%",
    ...
    iconSrc: "/landing/icons/coin.svg",
  },
]
